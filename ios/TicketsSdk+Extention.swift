...
protocol TicketsSdkViewProtocol: UIView {
  // Protocol doesn't need to define anything - just marks views that can use these delegates
}

extension TicketsSdkViewProtocol where Self: UIView {
