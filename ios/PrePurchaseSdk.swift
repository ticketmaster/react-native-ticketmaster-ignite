...
class PrePurchaseSdk: UIViewController {
  ...
  override func viewDidLoad() {
    ...
    TMPrePurchase.shared.configure(apiKey: apiKey, region: TMAuthentication.TMXDeploymentRegion(rawValue: region) ?? .US) { isPrePurchaseApiSet in
      ...
      if self.venueId != "" {
        ...
        viewController = TMPrePurchaseViewController.venueDetailsViewController(
          venueIdentifier: self.venueId,
          marketDomain: marketDomain,
          enclosingEnvironment: .modalPresentation,
          customFont: nil,
          customBoldFont: nil
        )
      } else {
        print("Set viewController to Attraction")
        viewController = TMPrePurchaseViewController.attractionDetailsViewController(
          attractionIdentifier: self.attractionId,
          marketDomain: marketDomain,
          enclosingEnvironment: .modalPresentation,
          customFont: nil,
          customBoldFont: nil
